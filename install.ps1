...
Copy-Item -Recurse -Force "$TempDir\QuickLoader" "$ModsDir\QuickLoader"

Write-Host 'Copying wrapper script to the game directory ...'
Copy-Item -Force "$TempDir\QuickLoader\QuickLoader.ps1" "C:\Program Files (x86)\Steam\steamapps\common\A Few Quick Matches\QuickLoader.ps1"
